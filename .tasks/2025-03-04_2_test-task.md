...
## Context
- **Task ID**: 2025-03-04_2
- **Created**: 2025-03-04_13:04:10
- **Created by**: Subhaj Limanond
- **Main branch**: integration-post
- **Task branch**: task/test-task_2025-03-04_2
- **YOLO MODE**: on
...
1. Create a new task branch from integration-post:
   ...
   git pull
   git checkout -b task/test-task_2025-03-04_2
   ```
...
1. Create the task file, naming it `2025-03-04_2_test-task.md` and place it in the `.tasks` directory.
...
2. If approved:
   ...
   - Merge:
     ```
     git merge task/test-task_2025-03-04_2
     ```
3. Confirm that the merge was successful by running:
   ```
   git log integration-post..task/test-task_2025-03-04_2 | cat
   ```
...
2. If approved, delete the task branch:
   ```
   git branch -d task/test-task_2025-03-04_2
   ```
