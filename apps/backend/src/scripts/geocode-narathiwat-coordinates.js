// Script to use Google Maps API to find administrative location for Narathiwat coordinates
...
async function geocodeCoordinates() {
  ...
  // Use the updated API key from .env
  ...
  const coordinates = [
    { latitude: 6.1867, longitude: 101.738, name: "นราธิวาส (Narathiwat)" }
  ];
  ...
  try {
    ...
    const resultsFile = 'narathiwat_geocode_results.json';
